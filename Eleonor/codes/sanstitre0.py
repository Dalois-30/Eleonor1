...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 21 23:46:14 2021
    ...
    def imprimer(self):
        ...
        if question > 0:
            ...
            if os.path.isdir('factures'):
                f1=open("factures/Facture N°"+str(numclient)+".txt", "w")
                f1.write(self.data)
                f1.close()
                self.destroy()
            else:
...
#===========================ARBORESCENCE DE PARAMETRES===========================
    ...
    def caissierConnect(self):
        ...
        bouttonNoCliquable = Button(self,height=3,text="Ne clique pas \nici nguenang", font=("arial", 20,"bold"),cursor="hand2",bg="black",fg="red",
                                    command=self.cliquable)
        bouttonNoCliquable.place(x=370, y=250)
        
    def cliquable(self):
        a=Label(self,text="TON GROS VAGIN POURRI QUI SENT \n AVEC LE KORO-KORO\n SUR CA\n SEXTOY AHAHAHAHAHAHAHAHAH",bg="black",fg="gold",
                font=("arial",30,"bold") )
        a.place(x=80,y=250)
